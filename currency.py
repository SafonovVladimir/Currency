...
l_btc_in = Label(f_cur, font='Arial 10', height=0, width=10)
...
l_btc_out = Label(f_cur, font='Arial 10', height=0, width=10)
l_btc_out.grid(row=9, column=3)

l_buy1 = Label(f_cur, text='Покупка', font='Arial 10', height=0, width=10)
l_buy1.grid(row=4, column=0)
l_buy1 = Label(f_cur, text='Продажа', font='Arial 10', height=0, width=10)
l_buy1.grid(row=5, column=0)
l_buy1 = Label(f_cur, text='Выдать', font='Arial 10', height=0, width=10)
l_buy1.grid(row=8, column=0)
l_buy1 = Label(f_cur, text='Получить', font='Arial 10', height=0, width=10)
l_buy1.grid(row=9, column=0)
